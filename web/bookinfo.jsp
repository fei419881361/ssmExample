        ...
        <div style="position: absolute ; left: 320px;top: 220px;" >
            <table style="height: 20px">
                ...
                <tr>
                    ...
                    <td><input type="text" name="bName" value="${param.bName}" style="background: #FBE5B3 ; border: 1px solid darkolivegreen"></td>
                </tr>
                <tr>
                    <td><img src="png/作者.png" height="60" width="100" ></img></td>
                    <td><input type="text" name="bAuthor" value="${param.bAuthor}" style="background: #FBE5B3 ; border: 1px solid darkolivegreen"></td>
                </tr>
                <tr>
                    <td><img src="png/位置.png" height="60" width="100" ></img></td>
                    <td><input type="text" name="bLocation" value="${param.bLocation}" style="background: #FBE5B3 ; border: 1px solid darkolivegreen"></td>
                </tr>
                <tr>
